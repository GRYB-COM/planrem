...
//---------------------------------------------------------------------------
__fastcall T_MozlRemWybFRM::T_MozlRemWybFRM(TComponent* Owner)
	: T_FCUSTWYB(Owner)
{
...
//---------------------------------------------------------------------------
__fastcall T_MozlRemWybFRM::~T_MozlRemWybFRM(void)
{
 delete m_WydzialSDB;
 delete m_WarSDB;
 delete m_Ini;
...
void __fastcall T_MozlRemWybFRM::FormShow(TObject *Sender)
{
 m_WydzialSDB->open();
...
void __fastcall T_MozlRemWybFRM::FormClose(TObject *Sender, TCloseAction &Action)
{
  m_WydzialSDB->close();
 m_WarSDB->close();
...
void __fastcall T_MozlRemWybFRM::m_WydzialCBCloseUp(TObject *Sender)
{
