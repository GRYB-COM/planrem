...
#ifndef MozlRemWybFRMH
#define MozlRemWybFRMH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class T_MozlRemWybFRM : public T_FCUSTWYB
{
...
public:
		...
		//KONSTRUKTOR DESTRUKTOR
		  __fastcall  T_MozlRemWybFRM(TComponent* Owner);
		  __fastcall ~T_MozlRemWybFRM(void);
private:
		//NARZEDZIA
