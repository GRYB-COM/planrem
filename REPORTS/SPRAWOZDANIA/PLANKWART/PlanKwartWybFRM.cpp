...
//---------------------------------------------------------------------------
__fastcall T_PlanKwartWybFRM::T_PlanKwartWybFRM(TComponent* Owner)
	: T_FCUSTWYB(Owner)
{
...
//---------------------------------------------------------------------------
__fastcall T_PlanKwartWybFRM::~T_PlanKwartWybFRM(void)
{
 delete m_WarSDB;
 delete m_Ini;
}
...
void __fastcall T_PlanKwartWybFRM::FormShow(TObject *Sender)
{
 m_WarSDB->open();
...
void __fastcall T_PlanKwartWybFRM::FormClose(TObject *Sender, TCloseAction &Action)
{
 m_WarSDB->close();
...
void __fastcall T_PlanKwartWybFRM::m_MiesOdCBCloseUp(TObject *Sender)
{
