...
#ifndef KwMozlWarWybFRMH
#define KwMozlWarWybFRMH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class T_KwMozlWarWybFRM : public T_FCUSTWYB
{
...
public:
		...
		//KONSTRUKTOR DESTRUKTOR
		  __fastcall  T_KwMozlWarWybFRM(TComponent* Owner);
		  __fastcall ~T_KwMozlWarWybFRM(void);
private:
		//NARZEDZIA
