...
//---------------------------------------------------------------------------
__fastcall T_RBH4OSWybFRM::T_RBH4OSWybFRM(TComponent* Owner)
	: T_FCUSTWYB(Owner)
{
...
//---------------------------------------------------------------------------
__fastcall T_RBH4OSWybFRM::~T_RBH4OSWybFRM(void)
{
 delete m_WydzialSDB;
 delete m_WarSDB;
 delete m_Ini;
...
void __fastcall T_RBH4OSWybFRM::FormShow(TObject *Sender)
{
 m_WydzialSDB->open();
...
void __fastcall T_RBH4OSWybFRM::FormClose(TObject *Sender, TCloseAction &Action)
{
  m_WydzialSDB->close();
 m_WarSDB->close();
...
void __fastcall T_RBH4OSWybFRM::m_WydzialCBCloseUp(TObject *Sender)
{
