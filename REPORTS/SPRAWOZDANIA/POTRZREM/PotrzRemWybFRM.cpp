...
//---------------------------------------------------------------------------
__fastcall T_PotrzRemWybFRM::T_PotrzRemWybFRM(TComponent* Owner)
	: T_FCUSTWYB(Owner)
{
...
//---------------------------------------------------------------------------
__fastcall T_PotrzRemWybFRM::~T_PotrzRemWybFRM(void)
{
 delete m_WydzialSDB;
 delete m_WarSDB;
 delete m_Ini;
...
void __fastcall T_PotrzRemWybFRM::FormShow(TObject *Sender)
{
 m_WydzialSDB->open();
...
void __fastcall T_PotrzRemWybFRM::FormClose(TObject *Sender, TCloseAction &Action)
{
  m_WydzialSDB->close();
 m_WarSDB->close();
...
void __fastcall T_PotrzRemWybFRM::m_WydzialCBCloseUp(TObject *Sender)
{
