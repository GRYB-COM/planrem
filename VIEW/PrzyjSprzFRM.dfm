object _PrzyjSprzFRM: T_PrzyjSprzFRM
  Left = 0
  Top = 0
  Caption = 'Przyj'#281'cie sprz'#281'tu'
  ClientHeight = 540
  ClientWidth = 664
  Color = clBtnFace
  ...
  object m_SearchPA: TAdvSmoothPanel
    ...
    object m_PrPrzyjED: TEdit
      ...
      TabOrder = 0
      Text = '41/11'
      OnKeyPress = m_PrPrzyjEDKeyPress
    end
    ...
    object m_DataPrzyjDTP: TAdvDateTimePicker
      Left = 87
      Top = 8
      Width = 81
      Height = 21
      Date = 41036.586179606480000000
      Time = 41036.586179606480000000
      DoubleBuffered = True
      Kind = dkDate
      ...
      Ctl3D = True
      DateTime = 41036.586179606480000000
      Version = '1.1.0.0'
  ...
  object AdvSmoothPanel2: TAdvSmoothPanel
    ...
    object edDost: TEdit
      ...
      ReadOnly = True
      TabOrder = 0
      Text = '3 Okr'#281'gowe Warsztaty Techniczne Nowy Dw'#243'r Mazowiecki'
    end
  end
