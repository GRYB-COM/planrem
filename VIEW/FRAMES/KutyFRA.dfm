object _KutyFRA: T_KutyFRA
  ...
  object m_BottomPA: TAdvSmoothPanel
    ...
    Align = alBottom
    TabOrder = 0
    object m_NewBT: TAdvSmoothButton
      Left = 3
      Top = 6
      Width = 68
      Height = 20
    ...
    object m_PrintBT: TAdvSmoothButton
      Left = 151
      Top = 6
      Width = 68
      Height = 20
    ...
    object m_DBG: TDBGrid
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'NR_KUT'
          Title.Caption = 'Nr KUT'
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'DATA_WYST'
          Title.Caption = 'Data Wystawienia'
          Width = 92
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'KOD_REM'
          Title.Caption = 'Kod Remontu'
          Width = 115
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'RODZAJ_REM'
          Title.Caption = 'Rodzaj remontu:'
          Width = 147
          Visible = True
        end
        item
          ...
          Title.Caption = 'Data prop. zak.'
          Width = 79
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'PRZESTOJ_OD'
          Title.Caption = 'Przestoj Od'
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'DLA_JW'
          Title.Caption = 'Dla JW'
          Visible = True
        end
        item
          Expanded = False
          Title.Caption = 'Data zdania KUT'
          Visible = True
        end
        item
          Expanded = False
          Title.Caption = 'Data Zako'#324'czenia'
          Visible = True
        end
        item
          Expanded = False
          Title.Caption = 'Ilosc RBH'
          Visible = True
        end
        item
          Expanded = False
